...
# MAGIC FROM 
# MAGIC   range(1,10) as a,
# MAGIC   range(5,10) as b
# MAGIC ) 
...
# MAGIC %md ### Save images to open Delta Lake format
# MAGIC * Optimize storage
# MAGIC * Optimize IO (writes & reads)
# MAGIC * Improve traceability

# COMMAND ----------

# DBTITLE 1,Save lots of small 'files' to the open Delta Lake format to optimize access
...
# MAGIC %sql DESCRIBE HISTORY delta.`/tmp/matplotlib_figures`

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from delta.`/tmp/matplotlib_figures` 
# MAGIC where x between 1 and 7 and y = 7
# MAGIC order by x, y

# COMMAND ----------

# DBTITLE 1,Optimize storage
# MAGIC %sql OPTIMIZE delta.`/tmp/matplotlib_figures`

# COMMAND ----------

# MAGIC %sql describe delta.`/tmp/matplotlib_figures` 

# COMMAND ----------

# MAGIC %sql select image from delta.`/tmp/matplotlib_figures`
