...
// MAGIC %md ## Load Subset of Cat Data

// COMMAND ----------

val dfp = spark.sql("""select * from douglas_moore_bronze.wikidata where o = "http://www.wikidata.org/entity/Q146" """)
...
WHERE 
{
  ?item ?p wd:Q146. # Must be of a cat
}
"""
...
dfp.sparql(q).explain

// COMMAND ----------

dfp.sparql(q).explain("extended")
...
// MAGIC %md # full data set

// COMMAND ----------

val dfp = spark.sql("""select * from douglas_moore_bronze.wikidata """)
...
// MAGIC %sql
// MAGIC select * from douglas_moore_bronze.wikidata_
